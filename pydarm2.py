...
def create_list_of_dict(filename):
	"return dictionary with question.... image...."
...
class Start:
	...
	def create_code_for_template(self):
		self.qdic = create_list_of_dict(self.filename)
